  ...
  describe.each(['setImmediate', 'setTimeout'])(
    ...
    timerFunctionName => {
          ...
          scheduleTask(() => {
            result = ReactServerDOMStaticServer.prerender(
              ...
              webpackMap,
              {
                ...
                filterStackFrame: (filename, functionName) => {
                  if (
                    functionName === 'createHangingPromise' ||
                    functionName === 'IgnoreListedComponent'
                  ) {
                    return false;
                  }
                  return filterStackFrame(filename, functionName);
      ...
      it('includes deeper location for unresolved I/O', async () => {
        ...
        function ComponentD() {
          const promise = new Promise(r => setTimeout(r));
        ...
        if (__DEV__) {
          ...
          expect(normalizedComponentStacks).toMatchInlineSnapshot(`
            [
              "
                in ComponentA (file:///packages/react-server-dom-webpack/src/__tests__/ReactFlightDOMNode-test.js:1227:17)
                in body
                in html
                in App (file:///packages/react-server-dom-webpack/src/__tests__/ReactFlightDOMNode-test.js:1253:27)
                in ClientRoot (/packages/react-server-dom-webpack/src/__tests__/ReactFlightDOMNode-test.js:949:56)",
              "
                in ComponentB (file:///packages/react-server-dom-webpack/src/__tests__/ReactFlightDOMNode-test.js:1232:17)
                in body
                in html
                in App (file:///packages/react-server-dom-webpack/src/__tests__/ReactFlightDOMNode-test.js:1253:27)
                in ClientRoot (/packages/react-server-dom-webpack/src/__tests__/ReactFlightDOMNode-test.js:949:56)",
              "
                in ComponentC (file:///packages/react-server-dom-webpack/src/__tests__/ReactFlightDOMNode-test.js:1237:11)
                in ComponentD (file:///packages/react-server-dom-webpack/src/__tests__/ReactFlightDOMNode-test.js:1243:30)
                in body
                in html
                in App (file:///packages/react-server-dom-webpack/src/__tests__/ReactFlightDOMNode-test.js:1253:27)
                in ClientRoot (/packages/react-server-dom-webpack/src/__tests__/ReactFlightDOMNode-test.js:949:56)",
        ...
        if (__DEV__) {
          expect(normalizedOwnerStacks).toMatchInlineSnapshot(`
            [
              ...
              "
                in ComponentB (file:///packages/react-server-dom-webpack/src/__tests__/ReactFlightDOMNode-test.js:1232:17)
                in App (file:///packages/react-server-dom-webpack/src/__tests__/ReactFlightDOMNode-test.js:1254:27)",
              "
                in ComponentC (file:///packages/react-server-dom-webpack/src/__tests__/ReactFlightDOMNode-test.js:1237:11)
                in ComponentD (file:///packages/react-server-dom-webpack/src/__tests__/ReactFlightDOMNode-test.js:1243:30)
                in App (file:///packages/react-server-dom-webpack/src/__tests__/ReactFlightDOMNode-test.js:1255:27)",
            ]
          `);
        } else {
